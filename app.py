...
# MONGODB_CONNECTION_STRING = "mongodb+srv://test:sparta@cluster0.atiyrt3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
# client = MongoClient(MONGODB_CONNECTION_STRING)
# db = client.dbsparta_plus_week9
...
def user(username):
    ...
    try:
        ...
        status = username == payload["id"]  #username sama dengan id berarti nilai true jika tidak sama nilai flase
